...
class uartParser():
    def __init__(self,type='SDK Out of Box Demo'):
        ...
        #self.saveBinary = 0
        self.saveBinary = 1  #alan@20230501 save UART output
        #self.replay = 0
        self.replay = 1 #alan@20230501 save UART output
    ...
    # Separate readAndParse function for the IWRL6432 because it has only 1 COM port for data and configuration
    def readAndParseUart6432(self):
        # Reopen CLI port
    ...
    def connectComPort(self, cliCom):
        self.cliCom = serial.Serial(cliCom, 115200,parity=serial.PARITY_NONE,stopbits=serial.STOPBITS_ONE,timeout=0.6)
